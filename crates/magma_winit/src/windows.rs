...
impl Windows {
    ...
    pub fn get_window_mut(&mut self, entity: usize) -> Option<&mut WindowWrapper<WinitWindow>> {
    ...
    pub fn remove_window(&mut self, window: usize) -> Option<WindowWrapper<WinitWindow>> {
    ...
    pub fn create_winit_window(
        ...
        let monitor_selection = &match window.mode {
            ...
            WindowMode::BorderlessFullscreen(monitor_selection) => match monitor_selection {
                ...
                MonitorSelection::Entity(entity) => match world
                    .component_store
                    .get_components_ref::<Monitor>()
                    .unwrap()
                    .get(entity)
                {
                    Some(monitor) => event_loop.available_monitors().nth(monitor.id),
                    None => None,
                },
            },
